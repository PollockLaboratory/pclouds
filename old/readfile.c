...
// Read a segmet of sequence to a buffer from sequence file
...
bool ReadPcloudsControlfile(const char* pchControlfile, int& size, int& m_nCopy, int& m_nEndthreshold, int& m_nStep1, int& m_nStep2, int& m_nStep3, int& m_nChunksize, unsigned int& m_nGenomesize, int&
windowsize, int& percent, int& m_nGetclouds, int& m_nDissection, char* pchrepeatfile, char* pchGenome, char* pchMainClouds, char* pchMainAssign, char* pchAccAssign, char* pchAnnotationfile, char* pchRegionfile)
{
